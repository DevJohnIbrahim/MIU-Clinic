...
<html>    
    ...
    <script type="text/javascript" src="../JavaScript/AdminReservedRecords.js"></script> 
    <link rel="stylesheet" type="text/css" href="../CSS/AdminReservedRecords.css"/>
	...
	<button type="button" id="b1" > Display Reservation records  </button>
	<br>
	<button type="button" id="b2" > Delete Reservation records  </button>
	<br>
    </main>
